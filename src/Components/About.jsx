...
export default function About() {
  return (
    <section
      id="about"
      className="flex lg:flex-row flex-col-reverse lg:justify-between lg:pt-32 pt-12 lg:px-16 px-10 items-center lg:space-x-6"
    >
      <article className="lg:flex lg:space-x-6">
        <aside className="space-y-3 lg:flex flex-col items-center w-20 hidden">
        ...
        <div className="w-full">
          <h3 className="lg:text-xl text-lg font-semibold text-[#707070]">
            Hi, I'm
          </h3>
          ...
          <div className="flex justify-center space-x-3 items-center lg:hidden">
            <a href="https://www.instagram.com/faizghozy23/" target={"_blank"}>
              <svg
                className="text-[#BFBFBF] h-7"
                xmlns="http://www.w3.org/2000/svg"
      ...
      <article id="lottie_dekstop" className="lg:flex hidden">
        <Lottie
          height={380}
          width={600}
          options={{
      ...
      <article id="lottie_mobile" className="lg:hidden">
        <Lottie
          height={380}
          width={300}
          options={{
